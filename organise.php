                ...
                if ($result->num_rows > 0) {
                    while( $arrayEvent = mysqli_fetch_assoc($result)){
                        if($arrayEvent != false){?>
                            <div class="grid_9">
                            <?php
                                $numProves = $db->recuperarNumProves($arrayEvent['Id']);
                                if ($numProves['COUNT(*)'] > 1) {?>
                                    ...
                                    ?>
                                <?php
                                //EVENT AMB UNA SOLA PROVA
                                }else {
                                    $proves = $db->recuperarProves($arrayEvent['Id'], true);
                                    $prova = null;
                                    if ($proves !== false) {
                                        $prova = mysqli_fetch_assoc($proves)
                                        ?>
                                        <div class='block3 click eventDiv'
                                             onclick="location.href='createProva.php?provaId=<?php echo $prova['Id']; ?>'">
                                            <div class='block2'>
                                                <div class='grid_7'>
                                                    <div class="grid_2">
                                                        <?php
                                                    ...
                                                    <div class="grid_4">
                                                        <h1 class="eventTitle"><?php echo $prova['nom'] ?></h1>
                                                        <a><?php echo $prova['poblacio'] ?></a>
                                                        <div class="fRight">
                                                            <a><?php echo date("Y-m-d", strtotime($arrayEvent['dataInici'])) ?></a>
                                                        </div>
